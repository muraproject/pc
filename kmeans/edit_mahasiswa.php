...
<form action="" method="POST">
    ...
    <div class="mb-3">
        ...
        <select class="form-select" id="penghasilan_ayah" name="penghasilan_ayah" required>
            ...
            <option value="2.000.000+" <?php echo ($mahasiswa['penghasilan_ayah'] == '2.000.000+') ? 'selected' : ''; ?>>2.000.000+</option>
        </select>
    </div>
    <div class="mb-3">
        ...
        <select class="form-select" id="penghasilan_ibu" name="penghasilan_ibu" required>
            ...
            <option value="2.000.000+" <?php echo ($mahasiswa['penghasilan_ibu'] == '2.000.000+') ? 'selected' : ''; ?>>2.000.000+</option>
        </select>
    </div>
    <div class="mb-3">
