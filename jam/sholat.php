...
<head>
    ...
    <style>
        ...
        body{
            background: #1c4211;  /* fallback for old browsers */
            background: -webkit-linear-gradient(to right, #1c4211, #1c6d06);  /* Chrome 10-25, Safari 5.1-6 */
            background: linear-gradient(to right, #1c4211, #1c6d06); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
        }
...
?>
    ...
    <body class="">
                ...
                <div>
                    ...
                    <div id="konten1">
                        <p class=""><img src="assets/images/lafadz-allah.png" style="border:0px;" width="100%"></img></p>
                        <!--<p></p>-->
                    </div>
